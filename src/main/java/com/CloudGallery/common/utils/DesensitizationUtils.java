...
//        System.out.println("GCM 加密结果: " + encryptedGCM);
        ...
        String password = "LQwxP9SFsiEnVKOxuqgZHJeJIoEs68ki3w64+PqHqz/sQMKkbp5J7Q1unTB0MN6SejStWaD8";
        String decryptedGCM = DesensitizationUtils.decrypt(password);
